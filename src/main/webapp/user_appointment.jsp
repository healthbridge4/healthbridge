	...
	<div class="container p-3">
		<div class="row">
			<div class="col-md-6 p-5">
				<img alt="" src="img/doct.jpg" width="400px" height="500px">
			</div>
			...
			<div class="col-md-6">
				<div class="card paint-card">
					<div class="card-body">
						...
						<c:if test="${not empty appointment_book}">
							<p class="fs-4 text-center text-danger">${appointment_book}</p>
							<c:remove var="appointment_book" scope="session" />
						</c:if>
						<form class="row g-3" action="bookAppointment" method="post">
							...
							<div class="col-md-6">
								<label for="inputEmail4" class="form-label">Full Name</label> <input
									...
									value="${userObj.fullName}" name="fullname">
							</div>
