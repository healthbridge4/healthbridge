<%@page import="com.healthbridge.entity.Specialist"%>
<%@page import="java.util.List"%>
<%@page import="com.healthbridge.db.DBConnect"%>
<%@page import="com.healthbridge.DAO.SpecialistDao"%>
            ...
            <div class="col-md-4">
                <div class="card paint-card">
                    <div class="card-body">
                        ...
                        <c:if test="${not empty docregister}">
                        <p class="fs-3 text-center text-danger">${docregister}</p>
                        </c:if>
                        <c:if test="${not empty docupdate}">
                        <p class="fs-3 text-center text-danger">${docupdate}</p>
                        <c:remove var="docupdate" scope="session"/>
                        </c:if>
                         <c:if test="${not empty docdelete}">
                        <p class="fs-3 text-center text-danger">${docdelete}</p>
                        <c:remove var="docdelete" scope="session"/>
                        </c:if>
