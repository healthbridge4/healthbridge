...
<%@ page import="com.healthbridge.db.DBConnect" import="java.sql.Connection"%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<div class="container p-3">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<img style="margin-top: 50px"alt="" src="img/doct.jpg" width="350px" height="350px">
			</div>
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Anand Kumar</p>
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Garvit Juneja</p>
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Siddharth Kumar</p>
						<p class="fs-7">(Chief Doctor)</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Milind kumar</p>
						<p class="fs-7">(Chief Doctor)</p>
					</div>
				</div>
			</div>
